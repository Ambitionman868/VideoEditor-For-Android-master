...
public class TestCameraDrawer implements GLSurfaceView.Renderer {
    ...
    public TestCameraDrawer(Resources resources) {
        //初始化一个滤镜 也可以叫控制器
...
//        showFilter.setTextureId(textureID);
    ...
    public void onSurfaceChanged(GL10 gl10, int i, int i1) {
        ...
        for (int j = 0; j < fFrame.length; j++) {
            /**创建一个帧染缓冲区对象*/
            GLES20.glGenFramebuffers(1, fFrame, j);
            /**根据纹理数量 返回的纹理索引*/
            GLES20.glGenTextures(1, fTexture, j);
       /* GLES20.glRenderbufferStorage(GLES20.GL_RENDERBUFFER, GLES20.GL_DEPTH_COMPONENT16, width,
                height);*/
            /**将生产的纹理名称和对应纹理进行绑定*/
            GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, fTexture[j]);
    ...
    public void onDrawFrame(GL10 gl10) {
        ...
        showFilter.setTextureId(fTexture[1]);
        showFilter.draw();
    ...
    public int getBeautyLevel() {
        return 0;//mBeautyFilter.getBeautyLevel();
    }
